package main.wampi.aq;

import com.mojang.logging.LogUtils;
import main.wampi.aq.block.AQBlocks;
import main.wampi.aq.item.AQCreativeModeTab;
...
public class AquaticAdditions
{
    ...
    public AquaticAdditions(FMLJavaModLoadingContext context)
    {
        ...
        AQCreativeModeTab.register(modEventBus);
